...
∇ Z ← five_hundred_and_five_to_roman_TEST
        #.UT.expect ← 'DV'
        Z ← #.roman.numeral 505
∇

∇ Z ← eight_hundred_and_ninety_nine_to_roman_TEST
        #.UT.expect ← 'DCCCXCIX'
        Z ← #.roman.numeral 899
∇
...
∇ Z ← nine_hundred_ninety_nine_to_roman_TEST
        #.UT.expect ← 'CMXCIX'
        Z ← #.roman.numeral 999
∇
...
∇ Z ← one_thousand_and_five_to_roman_TEST
        #.UT.expect ← 'MV'
